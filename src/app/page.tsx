...
<div className="mt-10 grid xl:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-6 mx-auto">
  {[
...
<div className="grid xl:grid-cols-4 md:grid-cols-3 grid-cols-1 gap-6 mt-20 mb-10">
  {[
